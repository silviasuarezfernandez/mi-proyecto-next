...
export default function PrivacyPolicyPage() {
  return (
    <main className={styles.container}>
      ...
      <h2 id="info-recogida">1. Información que recopilamos</h2>
      <p>
      ...
      <h2 id="derechos-usuario">4. Derechos del usuario</h2>
      <p>
        Tienes derecho a acceder, rectificar o eliminar tus datos personales en cualquier momento. Para ello, puedes escribirnos a{' '}
        <a href="mailto:LIBRERIA.ACUAREL@gmail.com" aria-label="Enviar email a libreria.acuarel@gmail.com">
          LIBRERIA.ACUAREL@gmail.com
        </a>.
      </p>

      <h2 id="cambios-politica">5. Cambios en esta política</h2>
      <p>
